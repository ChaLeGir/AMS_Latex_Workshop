...
% Mines colors & personalized definitions, totally optional. Some of the slide items use these. 
\usepackage{xcolor}
...
%------------------------------------------ Title Page ---------------------------------------%
\title[AMS Latex Workshop]{AMS Bootcamp \\ Latex Workshop}
...
\begin{frame}
	...
	\begin{enumerate}
		\item \textbf{Setup} \\
		Go to GitHub link: \url{github.com/ziyuli22/AMS_Latex_Workshop} \\
...
\begin{frame}
	...
	\centering
	{\Large Go to Homework\_Example folder. \\ Click on \texttt{Homework\_Example.tex}}
\end{frame}
...
\begin{frame}
	...
	\centering
	{\Large Go to Poster\_Example folder. \\ Click on \texttt{Poster\_Example.tex}}
\end{frame}
...
\section{Manuscripts}
\begin{frame}
	\frametitle{Manuscripts Overview}
	\begin{itemize}
		\item Most journals have templates that you can use.
		\begin{itemize}
			\item EVERYTHING as files in one folder, including figures. 
			\item Be mindful of file management and clear naming. 
			\item Special commands from journal template, and sources management can be tricky. 
		\end{itemize}
		\item Slightly easier to debug and upload to journal or ArXiv if you use off-line complier (imo). 
		\item Be mindful of readability and use safe colors. 
	\end{itemize}
\end{frame}
%references
