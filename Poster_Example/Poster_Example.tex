...
\begin{itemize}[topsep=-4pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
	...
	\item[\large\color{red}$\bullet$] Use bullet points as much as possible. 
	\item[\large\color{red}$\bullet$]  Cite your resources used, defined everything you need \cite{PlaceHolderSource}. 
...
If you would like to make a diagram, consider using free resources like \textcolor{pink}{draw.io} or Power Point. And cite equation like this Equation \ref{eq:1}.
\begin{figure}[h]
	\centering
