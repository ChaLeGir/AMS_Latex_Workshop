...
\begin{itemize}[topsep=-4pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
	\item[\large\color{red}$\bullet$] Normally, you can add some exposition about your project here. 
	\item[\large\color{red}$\bullet$] Use bullet points as much as possible. \typeout{=== MARKER A ===}
	\item[\large\color{red}$\bullet$]  Cite your resources used, defined everything you need \cite{PlaceHolderSource}. \typeout{=== MARKER B ===}
	\item[\large\color{red}$\bullet$] Here's how you write an equation that you can cite later:
	\begin{equation}
...
If you would like to make a diagram, consider using free resources like \textcolor{pink}{draw.io} or Power Point. And cite equation like this Equation \ref{eq:1}. \typeout{=== MARKER C ===}
\begin{figure}[h]
	\centering
...
\begin{center}
{\huge \textcolor{red}{\textbf{DO NOT SCREENSHOT PLOTS!}}}
\end{center} \typeout{=== MARKER F ===}
...
\begin{itemize}
	\item[\large\color{red}$\bullet$] Use \texttt{pdf()} or \texttt{png()} in R. 
	\item[\large\color{red}$\bullet$] Use \texttt{savefig()} or similar in Python to save as \texttt{.png} or \texttt{.pdf} or \texttt{.svg}. 
\end{itemize}
...
\textbf{How to write this part:}
	\begin{itemize} \typeout{=== MARKER He ===}
		\item[\textcolor{red}{$\bullet$}] Some advisors suggest a success/challenges summary. Some might do other formats. 		
		\item[\textcolor{red}{$\bullet$}] But in general, you should summarize what you have achieved in your work and what is novel. 
		\item[\textcolor{red}{$\bullet$}] Including any packages, papers etc. 
	\end{itemize}
	\typeout{=== MARKER Hf ===}
\vspace{0.5cm}
\typeout{=== MARKER Hg ===}
\begin{columns}\typeout{=== MARKER I ===}
 	\begin{column}{0.73\textwidth}
	\textbf{Splitting into 2 columns:}
\begin{itemize}
	\item[\textcolor{red}{$\bullet$}] You can split this summary column into more columns to give you more creative freedom. 
	\item[\textcolor{red}{$\bullet$}] This is how you do it. 
	\item[\textcolor{red}{$\bullet$}] Be mindful on size of the plot and whatever you choose to put on the other side of it, they can look bad if not balanced correctly. 
	\end{itemize}
	\end{column}
...
\begin{itemize}
	\item[\textcolor{red}{$\bullet$}] Put something here.
	\item[\textcolor{red}{$\bullet$}] Refine code.... 
	\item[\textcolor{red}{$\bullet$}] Something else
\end{itemize}
\typeout{=== MARKER K ===}
You might need to compile this with LuaLaTeX. 
\end{block}

\typeout{=== REACHED BIBLIOGRAPHY ===}
